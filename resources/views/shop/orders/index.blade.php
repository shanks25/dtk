...
//console.log(value.product.images.length);
                        table += '<tr>';
                        ...
                        table += '<td>' + value.product.name + '</td><td>' + value.note + '</td><td>{{Setting::get('currency')}}' + value.product.prices.price + '</td><td>' + value.quantity + '</td><td>{{Setting::get('currency')}}' + (value.quantity * value.product.prices.price) + '</td></tr>';
                        $.each(value.cart_addons, function (key, valuee) {
                            ...
                            <td>\
                                <strong>{{Setting::get('currency')}}" + valuee.addon_product.price + "</strong>\
                            </td>\
                            <td>" + value.quantity + "X" + valuee.quantity + "</td>\
                            <td>\
                                <p>{{Setting::get('currency')}}" + (value.quantity * valuee.addon_product.price * valuee.quantity) + "</p>\
                            </td>\
                        </tr>";
                        });
