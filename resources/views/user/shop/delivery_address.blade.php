            ...
            <div class="cart-left-outer col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="checkout-left-content delivery-address row" style="display: none">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="address-box-right">
                            <input type="hidden" class="delivery_km" value="{{$kilometer}}"/>
                            <input type="hidden" class="address_id" value="{{$address->id}}"/>
                            <h6 class="address-tit addr-type">{{$address->type}}</h6>
                            <p class="address-txt addr-map">{{$address->map_address}}</p>
                            <h6 class="address-delivery-time">{{$Shop->estimated_delivery_time}}
                                                    ...
                                                    <div class="saved-cards-box">
                                                        ...
                                                        <div class="saved-cards-box-top row m-0">
                                                            ...
                                                            <div class="saved-cards-box-center pull-left">
                                                                <p class="card-number">{{ str_pad(substr($card->last_four, -4), strlen($card->last_four), '*', STR_PAD_LEFT) }}</p>
                            ...
                            <div class="cart-section table-responsive">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <input type="hidden" name="to_discount" id="to_discount" value="{{$discount}}"  />
                                    </tr>
                                    <?php
                                    $discount = 0;
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td class="text-right to_tax">{{currencydecimal($tax-1)}}</td>
                                        <input type="hidden" name="to_tax" id="to_tax" value="{{$tax}}"  />
                                    </tr>
                                    <tr>
                                        <td>Delivery Charges</td>
                                        <td></td>
                                        <td class="text-right delivery_charge">{{currencydecimal($deliveryCharge)}}</td>
                                    </tr>
                                    <tr>
                                        <td>Total Distance</td>
                                        <td></td>
                                        <td class="text-right distance_in_km">{{ $totalDistance . ' km'}}</td>
                                    </tr>
                                    <tr>
                                        <th>To Pay</th>
                                        <th></th>
                                        <th class="text-right to_pay">{{currencydecimal($net-1)}}</th>
                                        <input type="hidden" name="amount" id="total_amount_pay"
                                        value="{{$net}}"/>
                                        <input type="hidden" id="user_address_id" name="user_address_id" value="{{ $address_id }}"/>
