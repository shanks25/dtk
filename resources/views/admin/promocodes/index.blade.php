 ...
 <td>
                                        @if(Setting::get('DEMO_MODE')==0)
                                            ...
                                            <button class="table-btn btn btn-icon btn-danger"
                                                    form="resource-delete-{{ $Promocode->id }}"><i class="fa fa-trash-o"></i>
                                            </button>
                                        @endif
                                        <form id="resource-delete-{{ $Promocode->id }}"
                                              action="{{ route('admin.promocodes.destroy', $Promocode->id)}}" method="POST">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                        </form>
                                    </td>
