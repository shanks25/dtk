    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('avatar')) {
                $User['avatar'] = asset('storage/' . $request->avatar->store('app/public/transporter/profile'));
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->has('settle')) {
                ...
                if ($request->hasFile('avatar')) {
                    $Update['avatar'] = asset('storage/' . $request->avatar->store('app/public/transporter/profile'));
                }
                $User->update($Update);
            }
