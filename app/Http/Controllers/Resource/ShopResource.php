...
class ShopResource extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('avatar')) {
                $Shop['avatar'] = asset('storage/app/public/shops/' . $request->avatar->store('shops'));
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $Update = $request->all();
            if ($request->hasFile('avatar')) {
                $Update['avatar'] = asset('storage/app/public/shops/' . $request->avatar->store('shops'));
            } else {
                unset($Update['avatar']);
            }
            if ($request->hasFile('default_banner')) {
                $Update['default_banner'] = asset('storage/app/public/shops/' . $request->default_banner->store('shops'));
            } else {
