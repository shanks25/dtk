...
//                    dd($e);
                ...
                try {
                    ...
                    if ($request->has('payment_mode')) {
                        ...
                        if ($request->payment_mode == 'bambora') {
//echo 'payable: '.$request->amount; die;
                ...
                try {
                    $details = "https://maps.googleapis.com/maps/api/directions/json?origin=" . $Shop->latitude . "," . $Shop->longitude . "&destination=" . $Useraddress->latitude . "," . $Useraddress->longitude . "&mode=driving&key=AIzaSyAuxmmUPDIXgiw84E9AX7bbbdFzkd0xd50";
                    $json = curl($details);
