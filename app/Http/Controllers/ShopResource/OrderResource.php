...
//var_dump($Order->id);
   $ordered_products= Usercart::with('product','product.prices','product.images','cart_addons')->where('order_id',$Order->id)->withTrashed()->get();
$i=0;
    /*foreach($ordered_products as $ordered_product) 
    {
       $orderproduct_details= Product::where('id',$ordered_product->product_id)->get();
       $array_of_products[$i] = $orderproduct_details;
       $i++;
    }*/
$Order->products = $ordered_products;
   ...
   $ordered_products= Usercart::with('product','product.prices','product.images','cart_addons')->where('order_id',$id)->withTrashed()->get();
   $i=0;
    foreach($ordered_products as $ordered_product) 
    {
       $orderproduct_details= Product::where('id',$ordered_product->product_id)->get();
